...
const SharedLayout = ({ role }: ShareLayoutProps) => {
    ...
    return (
        <div className="min-h-screen flex bg-gray-100">
            {/**Sidebar */}
            <aside className="min-h-screen  fixed  top-0 left-0  w-[4.5rem] md:w-[240px] lg:w-[280px] xl:w-[320px] bg-white border-r border-gray-300">
                <Sidebar role={role} />
            </aside>

            {/**Navigation Bar */}
            <div className="flex-1 ml-[4.5rem] md:ml-[240px] lg:ml-[280px] xl:ml-[320px]">
